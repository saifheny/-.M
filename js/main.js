  ...
  ALL_MODELS: {
    openai: {
      ...
      models: [
        ...
        { id: 'gpt-5.4-pro', name: 'GPT-5.4 Pro', actualId: 'gpt-5.4-pro', desc: 'تفكير متقدم', isFree: false },
        { id: 'gpt-5.4-mini', name: 'GPT-5.4 Mini', actualId: 'gpt-5.4-mini', desc: 'سريع جداً واقتصادي', isFree: true },
    ...
    gemini: {
      ...
      models: [
        { id: 'gemini-3.1-pro', name: 'Gemini 3.1 Pro', actualId: 'gemini-3.1-pro-preview', desc: 'الأحدث - تفكير تكيّفي', isFree: false },
        { id: 'gemini-2.5-pro', name: 'Gemini 2.5 Pro', actualId: 'gemini-2.5-pro-preview-05-06', desc: 'مستقر وإنتاجي', isFree: false },
        { id: 'gemini-3.1-flash', name: 'Gemini 3.1 Flash', actualId: 'gemini-3.1-flash-preview', desc: 'أداء فائق السرعة', isFree: true },
        { id: 'gemini-3.1-flash-lite', name: 'Gemini 3.1 Flash Lite', actualId: 'gemini-3.1-flash-lite-preview', desc: 'أقل تكلفة وأسرع', isFree: true },
    ...
    anthropic: {
      ...
      models: [
        { id: 'claude-opus-4.7', name: 'Claude Opus 4.7', actualId: 'claude-opus-4-20260416', desc: 'الأذكى - تحليل عميق', isFree: false },
        { id: 'claude-sonnet-4.6', name: 'Claude Sonnet 4.6', actualId: 'claude-sonnet-4-20260214', desc: 'برمجة وتخطيط متقدم', isFree: false },
        { id: 'claude-haiku-4.5', name: 'Claude Haiku 4.5', actualId: 'claude-haiku-4-20251022', desc: 'سريع واقتصادي', isFree: true },
        { id: 'claude-3.5-sonnet', name: 'Claude 3.5 Sonnet', actualId: 'claude-3-5-sonnet-20241022', desc: 'كتابة وتحليل متوازن', isFree: true }
      ]
    },
    groq: {
      name: 'Meta / Groq', icon: 'box', color: 'var(--red)', bg: 'rgba(239,68,68,0.1)', url: 'https://api.groq.com/openai/v1/chat/completions',
      models: [
        { id: 'llama-4-maverick', name: 'Llama 4 Maverick', actualId: 'meta-llama/llama-4-maverick-17b-128e-instruct', desc: 'أحدث نماذج ميتا', isFree: false },
        { id: 'llama-4-scout', name: 'Llama 4 Scout', actualId: 'meta-llama/llama-4-scout-17b-16e-instruct', desc: 'سريع ودقيق', isFree: false },
        ...
        { id: 'gemma-2-9b', name: 'Gemma 2 9B', actualId: 'gemma2-9b-it', desc: 'من جوجل عبر Groq', isFree: true }
      ]
    },
    mistral: {
      name: 'Mistral AI', icon: 'wind', color: 'var(--orange)', bg: 'rgba(249,115,22,0.1)', url: 'https://api.mistral.ai/v1/chat/completions',
      models: [
        { id: 'mistral-large', name: 'Mistral Large', actualId: 'mistral-large-latest', desc: 'أقوى نماذج ميسترال', isFree: false },
        { id: 'mistral-medium', name: 'Mistral Medium', actualId: 'mistral-medium-latest', desc: 'أداء متوازن', isFree: false },
        { id: 'pixtral-large', name: 'Pixtral Large', actualId: 'pixtral-large-latest', desc: 'رؤية وتحليل صور', isFree: false },
        { id: 'mistral-small', name: 'Mistral Small', actualId: 'mistral-small-latest', desc: 'سريع للردود اليومية', isFree: true },
        { id: 'codestral', name: 'Codestral', actualId: 'codestral-latest', desc: 'متخصص بالبرمجة', isFree: true }
      ]
    },
    local: {
  ...
  async toggleVoice() {
    ...
    try {
      ...
      if (e.name === 'NotAllowedError' || e.name === 'PermissionDeniedError') {
        UI.toast('يرجى السماح بالوصول للميكروفون من إعدادات المتصفح', 'error');
      } else {
